...
const char *main_title = "ESMART IOT";
const char *sub_title = "WIFI Manager";
const char *footer_tag = "NGUYEN LUU THUONG";
...
void wifiScan()
{
   ...
   else
   {
      ...
      Serial.print("Unique SSIDs Count:");
...
void handlePostRequest(AsyncWebServerRequest *request, uint8_t *data, size_t len, size_t index, size_t total)
{
   ...
   if (String(requestType) == "wifi-scan")
   {
      ...
      Serial.print("wifiScanActive: ");
      Serial.println(wifiScanActive);
